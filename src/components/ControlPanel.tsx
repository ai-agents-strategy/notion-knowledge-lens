    ...
    <Card className="bg-slate-800/50 backdrop-blur-sm border-slate-700/50 text-white h-fit">
      <CardHeader>
        ...
        <CardDescription className="text-slate-300">
          Customize your knowledge graph visualization
        </CardDescription>
      </CardHeader>
      ...
      <CardContent className="space-y-6">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="bg-slate-700/30 rounded-lg p-3 text-center">
            ...
            <div className="text-xs text-slate-300">Databases</div>
          </div>
          <div className="bg-slate-700/30 rounded-lg p-3 text-center">
        ...
        <div className="space-y-4">
          <h3 className="text-sm font-semibold text-slate-200">Connection Options</h3>
        ...
        {/* Legend */}
        <div>
          <h3 className="text-sm font-semibold mb-3 text-slate-200">Connection Types</h3>
          <div className="space-y-2 text-xs">
            <div className="flex items-center gap-2">
              <div className="w-4 h-0.5 bg-blue-400 rounded"></div>
              <span className="text-slate-300">Relation</span>
            </div>
            <div className="flex items-center gap-2">
