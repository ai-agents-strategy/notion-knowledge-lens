...
export const GraphHeader = ({
  ...
  return <div className="bg-white/95 backdrop-blur-sm border-b border-gray-200 px-6 py-4">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-3 ml-auto">
          ...
          {hasNotionApiKey && <Button variant="outline" size="sm" onClick={onToggleDataSource} className="flex items-center gap-2" disabled={!realDataExists && !usingRealData}>
              {usingRealData ? <>
